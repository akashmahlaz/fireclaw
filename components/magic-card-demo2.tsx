    ...
    <Card className="w-full max-w-sm border-none p-0 shadow-none">
      ...
      >
        ...
        <CardFooter className="border-border border-t p-4 [.border-t]:pt-4">
          <Button className="w-full" render={<Link href="https://github.com/Yeom-JinHo" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2" />} nativeButton={false}><svg viewBox="0 0 438.549 438.549" className="size-4">
                                  <path
                                    fill="currentColor"
